...
* Módulo...........: PS                                                     *
* Programa.........: ZRAG_ORD_CUSTO_REAL                                    *
* Transação........:                                                        *
* Tipo de Prg......: Report                                                 *
* Objetivo.........: Extração de custos reais para Ordens (KOB1)            *
* Data.............: 16/08/2018                                             *
* --------------------------------------------------------------------------*
* Request    | Descrição                                                    *
* --------------------------------------------------------------------------*
...
DATA:
  ...
  ti_ext_ord_cr TYPE ztps_ext_ord_custo_real ##NEEDED.
...
*         Obter os custos reais para Ordens (KOB1)
          CALL FUNCTION 'ZFPS_OBTER_ORD_CUSTO_REAL'
            EXPORTING
              p_i_so_ordem      = so_ord[]
              p_i_grp_ord       = pa_grp
              p_i_so_empresas   = so_emp[]
              p_i_so_status     = so_st[]    "Lista de Status a desconsiderar
              p_i_so_data_lanc  = so_data[]
...
*       Nenhum dado selecionado para o filtro informado.
      ...
      IF p_local IS NOT INITIAL.
        ...
        cl_salv_table=>factory( IMPORTING r_salv_table = lo_table CHANGING t_table = ti_ext_ord_cr ).
        lo_table->display( ).
