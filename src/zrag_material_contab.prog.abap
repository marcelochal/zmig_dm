*&---------------------------------------------------------------------*
*& Report ZRAG_MATERIAL_CONTAB
*&---------------------------------------------------------------------*
*&  Programa de Extração MM - MESTRE MATERIAL - VISAO CONTABILIDADE 1 E 2
...
DATA:
  ...
  ti_mbew                  TYPE TABLE OF mbew,
  ti_mat_imp               TYPE TABLE OF ty_mat,
  ti_mat_exp               TYPE TABLE OF ty_mat_exp,
  wa_mat_exp               TYPE ty_mat_exp,
  wa_mat                   TYPE ty_mat,
  li_pos                   TYPE i,
  ti_layout_contab_cockpit TYPE STANDARD TABLE OF ZEMM_EXT_MAT_CONTAB,
  wa_layout_contab_cockpit TYPE ZEMM_EXT_MAT_CONTAB.

FIELD-SYMBOLS <t_tab>  TYPE STANDARD TABLE.

SELECTION-SCREEN BEGIN OF BLOCK b1 WITH FRAME TITLE text-t00.
SELECT-OPTIONS : so_bwkey  FOR gc_bwkey NO INTERVALS OBLIGATORY MATCHCODE OBJECT H_T001K.
...
*** Seleciona o universo de materiais a serem extraidos
  ...
  TRY .
      ...
      MOVE-CORRESPONDING ti_mbew TO ti_layout_contab_cockpit.

** Monta dados da mara

      FIELD-SYMBOLS: <fs_mat> TYPE ZEMM_EXT_MAT_CONTAB.

      SORT ti_mat_exp BY matnr.

      LOOP AT ti_layout_contab_cockpit ASSIGNING <fs_mat>.
      ...
      IF p_local IS NOT INITIAL.
        cl_salv_table=>factory( IMPORTING r_salv_table = lo_table CHANGING t_table = ti_layout_contab_cockpit ).
        lo_table->display( ).
      ...
      ELSE.
        ...
        ASSIGN ti_layout_contab_cockpit TO <t_tab>.
        EXPORT:
