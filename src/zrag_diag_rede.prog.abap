...
* Módulo...........: PS                                                     *
* Programa.........: ZRAG_DIAG_REDE                                         *
* Transação........:                                                        *
* Tipo de Prg......: Report                                                 *
* Objetivo.........: Extração de Diagramas de Rede (CN46N)                  *
* Data.............: 14/07/2018                                             *
* --------------------------------------------------------------------------*
* Request    | Descrição                                                    *
* --------------------------------------------------------------------------*
...
DATA:
  ...
  ti_ext_dr     TYPE ztps_ext_diagrama_rede ##NEEDED.
...
*       Nenhum dado selecionado para o filtro informado.
      ...
      IF p_local IS NOT INITIAL.
        ...
        cl_salv_table=>factory( IMPORTING r_salv_table = lo_table CHANGING t_table = ti_ext_dr ).
        lo_table->display( ).
