*&---------------------------------------------------------------------*
*& Report ZRAG_FORNECEDOR_FUNCPARC
*&---------------------------------------------------------------------*
*&  Programa de Extração MM - MESTRE FORNECEDOR - FUNCAO PARCEIRO
...
DATA:
  ...
  ti_wyt3                  TYPE TABLE OF WYT3,
  ti_fornec_imp            TYPE TABLE OF ty_fornec,
  ti_fornec_exp            TYPE TABLE OF ty_fornec,
  wa_fornec                TYPE ty_fornec,
  li_pos                   TYPE i,
  ti_layout_fornec_cockpit TYPE STANDARD TABLE OF ZEMM_EXT_MAT_FORNEC_FUNCPARC,
  wa_layout_fornec_cockpit TYPE ZEMM_EXT_MAT_FORNEC_FUNCPARC.

FIELD-SYMBOLS <t_tab>  TYPE STANDARD TABLE.

SELECTION-SCREEN BEGIN OF BLOCK b1 WITH FRAME TITLE text-t00.
SELECT-OPTIONS : so_lifnr  FOR gc_lifnr MATCHCODE OBJECT KRED_C NO INTERVALS.
SELECT-OPTIONS : so_ekorg  FOR gc_ekorg MATCHCODE OBJECT H_T024E NO INTERVALS OBLIGATORY.
...
CALL FUNCTION 'ZFMM_EXTRACAO_SELECIONA_FORNEC'
  ...
  TRY .
      ...
      MOVE-CORRESPONDING ti_wyt3 TO ti_layout_fornec_cockpit.

** Monta dados da mara

      FIELD-SYMBOLS: <fs_for> TYPE ZEMM_EXT_MAT_FORNEC_FUNCPARC.
