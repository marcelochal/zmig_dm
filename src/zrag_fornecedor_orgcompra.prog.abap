*&---------------------------------------------------------------------*
*& Report ZRAG_FORNECEDOR_ORGCOMPRA
*&---------------------------------------------------------------------*
*&  Programa de Extração MM - MESTRE FORNECEDOR - ORG.COMPRA
...
DATA:
  ...
  ti_lfm1                  TYPE TABLE OF lfm1,
  ti_fornec_imp            TYPE TABLE OF ty_fornec,
  ti_fornec_exp            TYPE TABLE OF ty_fornec,
  wa_fornec                TYPE ty_fornec,
  li_pos                   TYPE i,
  ti_layout_fornec_cockpit TYPE STANDARD TABLE OF ZEMM_EXT_MAT_FORNEC_ORGCOMPRA,
  wa_layout_fornec_cockpit TYPE ZEMM_EXT_MAT_FORNEC_ORGCOMPRA.
...
CALL FUNCTION 'ZFMM_EXTRACAO_SELECIONA_FORNEC'
  ...
  TRY .
      ...
      MOVE-CORRESPONDING ti_lfm1 TO ti_layout_fornec_cockpit.

** Monta dados da mara

      FIELD-SYMBOLS: <fs_for> TYPE ZEMM_EXT_MAT_FORNEC_ORGCOMPRA.
