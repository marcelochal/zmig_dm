...
*&---------------------------------------------------------------------*
*&  Programa de Extração MM - MESTRE MATERIAL - COMERCIO EXTERIOR
*&  Programador: Wilson Perotta Jose
*&---------------------------------------------------------------------
REPORT ZRAG_MATERIAL_COMERC_EXT.
...
DATA:
  ...
  wa_mat                   TYPE ty_mat,
  li_pos                   TYPE i,
  ti_layout_comext_cockpit TYPE STANDARD TABLE OF ZEMM_EXT_MAT_COMEXT,
  wa_layout_comext_cockpit TYPE ZEMM_EXT_MAT_COMEXT.
...
*** Seleciona o universo de materiais a serem extraidos
  ...
  TRY .
      ...
      MOVE-CORRESPONDING ti_marc TO ti_layout_comext_cockpit.

** Monta dados da mara

      FIELD-SYMBOLS: <fs_mat> TYPE ZEMM_EXT_MAT_COMEXT.

      SORT ti_mat_exp BY matnr.

      LOOP AT ti_layout_comext_cockpit ASSIGNING <fs_mat>.
      ...
      IF p_local IS NOT INITIAL.
        cl_salv_table=>factory( IMPORTING r_salv_table = lo_table CHANGING t_table = ti_layout_comext_cockpit ).
        lo_table->display( ).
      ...
      ELSE.
        ...
        ASSIGN ti_layout_comext_cockpit TO <t_tab>.
        EXPORT:
